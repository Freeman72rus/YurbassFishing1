class SpinningList {
static Spinning spinning_1 = new Spinning(0,"Lord","src\\\\Image\\\\dev\\\\sp_lord.jpg", 3000, 150, 100);
static Spinning spinning_2 = new Spinning(0,"Cottus 000", "src\\\\Image\\\\dev\\\\sp_cottus 000.jpg", 4000, 200, 100);
...
static Spinning[] spinningList = {spinning_1, spinning_2};
    static class Spinning{
        ...
        Spinning(int spinCount, String spinName, String spinPathImage, double spinCapacity, int spinPrice, int spinSafety){
